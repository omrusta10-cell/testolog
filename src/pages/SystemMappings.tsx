...
export default function SystemMappings() {
  ...
  const defaultTables = [
    ...
    { key: "guild_grade", label: "Lonca Rütbeleri", default: "guild_grade" },
    { key: "guild_comment", label: "Lonca Yorumları", default: "guild_comment" },
    ...
    { key: "item_award_old", label: "Eski Ödüller", default: "item_award_old" },
    ...
    { key: "levellog", label: "Seviye Logları", default: "levellog" },
    { key: "goldlog", label: "Yang Logları", default: "goldlog" },
    { key: "itemlog", label: "Eşya Logları", default: "itemlog" },
    { key: "loginlog", label: "Giriş Logları", default: "loginlog" },
    { key: "shout_log", label: "Bağırma Logları", default: "shout_log" },
    ...
    { key: "item_attr_rare", label: "6-7. Efsunlar", default: "item_attr_rare" },
    ...
    { key: "offlineshop_shops", label: "Çevrimdışı Pazarlar", default: "offlineshop_shops" },
    { key: "offlineshop_items", label: "Pazar Eşyaları", default: "offlineshop_shop_items" },
    { key: "offlineshop_sales", label: "Pazar Satışları", default: "offline_shop_sales" },
    { key: "offlineshop_auctions", label: "Açık Artırmalar", default: "offlineshop_auctions" },
    { key: "offlineshop_auction_offers", label: "Müzayede Teklifleri", default: "offlineshop_auction_offers" },
    { key: "offlineshop_offers", label: "Pazar Teklifleri", default: "offlineshop_offers" },
    { key: "offlineshop_safebox_items", label: "Pazar Depo Eşyaları", default: "offlineshop_safebox_items" },
    { key: "offlineshop_safebox_valutes", label: "Pazar Depo Paraları", default: "offlineshop_safebox_valutes" },
    { key: "pet_system", label: "Pet Sistemi", default: "new_petsystem" },
    { key: "dragon_soul", label: "Ejderha Taşı (DSS)", default: "dragonsoul_items" },
    { key: "guild_war", label: "Lonca Savaşları", default: "guild_war" },
    { key: "guild_war_bet", label: "Lonca Savaşı Bahisleri", default: "guild_war_bet" },
    { key: "guild_war_reservation", label: "Lonca Savaşı Rezervasyonları", default: "guild_war_reservation" },
    { key: "monarch", label: "Monarşi (Krallık)", default: "monarch" },
    { key: "monarch_candidacy", label: "Krallık Adaylığı", default: "monarch_candidacy" },
    { key: "monarch_election", label: "Krallık Seçimleri", default: "monarch_election" },
    { key: "pcbang_ip", label: "PC Bang IP Adresleri", default: "pcbang_ip" },
    { key: "change_empire", label: "Krallık Değişim Kayıtları", default: "change_empire" },
    { key: "exchange_yang", label: "Yang Transfer Kayıtları", default: "exchange_yang" },
    { key: "card", label: "Kart Oyunu Kayıtları", default: "card" },
    { key: "lotto_list", label: "Piyango Kayıtları", default: "lotto_list" },
    { key: "horse_name", label: "At İsimleri", default: "horse_name" },
    { key: "myshop_pricelist", label: "Pazar Fiyat Listesi", default: "myshop_pricelist" },
    { key: "highscore", label: "Yüksek Skorlar", default: "highscore" }
  ];
